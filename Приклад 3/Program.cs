...
namespace ConsoleApp27
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Заповнення масивів типу int
            for (j = 0; j < 10; j++)
            {
                iArray1[j] = rnd.Next(1, 101); // Випадкове число від 1 до 100
                iArray2[j] = 50 - rnd.Next(1, 101); // Випадкове число від -50 до 50
            }

            // Заповнення масивів типу double
            for (j = 0; j < 10; j++)
            {
                num1 = rnd.Next(1, 101);
